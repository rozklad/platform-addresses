...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'countries');

		$('.daterangepicker_end_input').attr('data-grid', 'countries');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('countries', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
